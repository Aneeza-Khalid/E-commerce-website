...
export default function ShopDetailFive() {
  ...
  const handleAddToCart = () => {
    ...
    const existingItemIndex = cartItems.findIndex(item => item.name === 'Drone 3 Pro Plus');
                ...
                >
                  <Carousel.Item className='w-100'>
                    <img
                      ...
                      src="https://i.ibb.co/5MTdNfM/5th.jpg"
                      alt="First slide"
                      width="800"
                      height="400"
                    />
