...
export default function ShopDetailOne() {
  ...
  const handleAddToCart = () => {
    ...
    const existingItemIndex = cartItems.findIndex(item => item.name === 'Drone Ultra');
    if (existingItemIndex !== -1) {
      ...
      const newItem = {
        ...
        price: 799.0,
        quantity,
        imageUrl:"https://i.ibb.co/mb7pk0k/646c624c3b4156dfbf4754c1-drone-photo-medium-p-500.jpg",
      };
      setCartItems([...cartItems, newItem]);
    }
    // Open the cart modal after adding the product
    handleCartModalShow();
  };
          ...
          <Row>
                ...
                >
                  <Carousel.Item className='w-100'>
                    <img
                      ...
                      src="https://i.ibb.co/mb7pk0k/646c624c3b4156dfbf4754c1-drone-photo-medium-p-500.jpg"
                      alt="First slide"
                      width="800"
                      height="400"
                    />
            ...
            <Col md={5} className=' ms-md-5 pt-3'>
              ...
              <Row className='mt-4 '>
                ...
                <Col xs={6}>
                  <Button
                    className='text-capitalize white-btn shop-btn px-4 ms-5 py-3'
