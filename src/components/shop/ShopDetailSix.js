...
export default function ShopDetailSix() {
  ...
  const handleAddToCart = () => {
    ...
    const existingItemIndex = cartItems.findIndex(item => item.name === 'Drone 4 pro plus');
    if (existingItemIndex !== -1) {
      ...
      const newItem = {
        ...
        name: 'Drone 4 pro plus',
        price: 799.0,
        quantity: parseInt(quantity),
        imageUrl: "https://i.ibb.co/GHwgMXp/6th.jpg",
      };
                ...
                >
                  <Carousel.Item className='w-100'>
                    <img
                      ...
                      src="https://i.ibb.co/GHwgMXp/6th.jpg"
                      alt="First slide"
                      width="800"
                      height="400"
                    />
