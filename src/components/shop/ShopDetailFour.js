...
export default function ShopDetailFour() {
  ...
  const handleAddToCart = () => {
    ...
    const existingItemIndex = cartItems.findIndex(item => item.name === 'Standard Drone');
    if (existingItemIndex !== -1) {
      ...
      const newItem = {
        ...
        imageUrl: "https://i.ibb.co/NCwgR0N/4th.jpg",
      };
                ...
                >
                  <Carousel.Item className='w-100'>
                    <img
                      ...
                      src="https://i.ibb.co/NCwgR0N/4th.jpg"
                      alt="First slide"
                      width="800"
                      height="400"
                    />
