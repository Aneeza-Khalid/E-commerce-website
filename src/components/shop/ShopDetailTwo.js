...
export default function ShopDetailTwo() {
  ...
  const handleAddToCart = () => {
    ...
    const existingItemIndex = cartItems.findIndex(item => item.name === 'Drone Ultra Light');
    if (existingItemIndex !== -1) {
      ...
      const newItem = {
        ...
        name: 'Drone Ultra Light',
        price: 599.0,
        quantity: parseInt(quantity), // Parse quantity to ensure it's a number
        imageUrl: "https://i.ibb.co/vddqKvb/2nd-drone.jpg",
      };
                ...
                >
                  <Carousel.Item className='w-100'>
                    <img
                      ...
                      src="https://i.ibb.co/vddqKvb/2nd-drone.jpg"
                      alt="First slide"
                      width="800"
                      height="400"
                    />
