...
export default function ShopDetailThree() {
  ...
  const handleAddToCart = () => {
    ...
    const existingItemIndex = cartItems.findIndex(item => item.name === 'Drone With Reciever');
    if (existingItemIndex !== -1) {
      ...
      const newItem = {
        ...
        name: 'Drone With Reciever',
        price: 299.0,
        quantity,
        imageUrl:"https://i.ibb.co/GPs62vb/3rd.jpg",
      };
                ...
                >
                  <Carousel.Item className='w-100'>
                    <img
                      ...
                      src="https://i.ibb.co/GPs62vb/3rd.jpg"
                      alt="First slide"
                      width="800"
                      height="400"
                    />
